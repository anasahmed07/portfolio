...
import AnimatedProfilePicture from '@/components/homePageComponents/AnimatedProfilePicture';
      ...
      <div className=" max-w-3xl mx-auto px-4 md:px-8 py-8 md:py-12">
        <div className="mb-16">
          <div className="flex flex-col md:flex-row items-start gap-6 md:gap-8">
            ...
            <div>
              <h1 className="text-xl mt-3 font-semibold mb-2 text-cg-1">👋 Hello I Am</h1>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 ">Anas Ahmed</h2>
              <p className="text-cg-1 font font-semibold max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-6">
                <Button variant="secondary" className="gap-2">
                  <Mail className="w-4 h-4" /><HyperText className='text-cg-6 text-xl' duration={150} text='EMAIL ME'/>
                </Button>
                <Button variant="secondary" className="gap-2">
                  <Phone className="w-4 h-4" /><HyperText className='text-cg-6 text-xl' duration={150} text='SHEDULE CALL'/>
                </Button>
              </div>
            </div>
          </div>
        ...
        <section className="mb-16">
          <h2 className="text-xl font-bold mb-6"><BriefcaseBusiness/> My Experience</h2>
